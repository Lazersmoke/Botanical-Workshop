...
public final class LexiconData{
	...
	public static void init(){
		...
		/*
		 * How to format these entries: name = new ?LexiconEntry(LibLexicon.?, category?); name[.setPriority()].setLexiconPages( new Page?("0"), new Page?("1"), . . . new Page?("n") ); <LINEBREAK> name = new ?LexiconEntry(LibLexicon.?, category?); . . . etc
		 */
