...
public final class LexiconData{
	...
	public static void init(){
		...
		elvenPool = new WLexiconEntry(LibLexicon.WORKSHOP_ELVENPOOL,
				categoryWorkshop);
		elvenPool.setLexiconPages(new PageText("0"), new PageCraftingRecipe(
				"1", ModCraftingRecipes.recipeElvenPool), new PageElvenRecipe(
				"2", ModElvenTradeRecipes.elvenPoolRecipe));

		elvenStar = new WLexiconEntry(LibLexicon.WORKSHOP_ELVENSTAR,
				categoryWorkshop);
		elvenStar.setLexiconPages(new PageText("0"),
				new PagePetalRecipe<RecipePetals>("1",
						ModPetalRecipes.elvenStarRecipe));

		logicalSound = new WLexiconEntry(LibLexicon.WORKSHOP_LOGICALSOUND,
				categoryWorkshop);
		logicalSound.setLexiconPages(new PageText("0"),
				new PagePetalRecipe<RecipePetals>("1",
						ModPetalRecipes.logicalSoundRecipe));

		gatewayCore = new WLexiconEntry(LibLexicon.WORKSHOP_GATEWAYCORE,
				categoryWorkshop);
		gatewayCore.setPriority()
				.setLexiconPages(
						new PageText("0"),
						new PageCraftingRecipe("1",
								ModCraftingRecipes.recipeWeakGatewayCore),
						new PageElvenRecipe("2",
								ModElvenTradeRecipes.gatewayCoreRecipe),
						new PageImage("3", LibResources.PREFIX_ENTRIES
								+ LibResources.ENTRIES_GATEWAY[0]),
						new PageImage("4", LibResources.PREFIX_ENTRIES
								+ LibResources.ENTRIES_GATEWAY[1]),
						new PageImage("5", LibResources.PREFIX_ENTRIES
								+ LibResources.ENTRIES_GATEWAY[2]),
						new PageImage("6", LibResources.PREFIX_ENTRIES
								+ LibResources.ENTRIES_GATEWAY[3]),
						new PageImage("7", LibResources.PREFIX_ENTRIES
								+ LibResources.ENTRIES_GATEWAY[4]),
						new PageText("8"), new PageText("9"),
						new PageText("10"));

		bindingCrystal = new WLexiconEntry(LibLexicon.WORKSHOP_BINDINGCRYSTAL,
				categoryWorkshop);
		bindingCrystal
				.setPriority()
				.setLexiconPages(
						...
						new PageGatewayTransmutationRecipe(
								"1",
								ModGatewayTransmutationRecipes.manaBindingCrystalRecipe),
						new PageGatewayTransmutationRecipe(
								"2",
								ModGatewayTransmutationRecipes.bloodBindingCrystalRecipe),
						new PageGatewayTransmutationRecipe(
								"3",
								ModGatewayTransmutationRecipes.thaumicBindingCrystalRecipe),
						new PageGatewayTransmutationRecipe(
								"4",
								ModGatewayTransmutationRecipes.mechanicalBindingCrystalRecipe));

		basicCatalyst = new WLexiconEntry(LibLexicon.WORKSHOP_BASICCATALYST,
				categoryWorkshop);
		basicCatalyst.setPriority().setLexiconPages(
				new PageText("0"),
				new PageText("1"),
				new PageCraftingRecipe("2",
						ModCraftingRecipes.recipeSimpleCatalyst),
				new PageText("3"),
				new PageCraftingRecipe("4",
						ModCraftingRecipes.recipeEmptyCatalyst));
