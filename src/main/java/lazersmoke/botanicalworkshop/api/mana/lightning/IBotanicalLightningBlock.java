...
/**
 * Any class implementing this interface will be considered a Lightning Block and will be updated and connected to the lightning network. Lightning Blocks with less conductivity give lightning to Lightning Blocks with more conductivity. <b>Implementation Instructions:</b><br>
 * - Override invalidate() and onChunkUnload(), calling <i>LightningNetworkEvent.removeBlock(this);</i> on both.<br>
 * - On the first tick of onUpdate(), call <i>LightningNetworkEvent.addBlock(this);</i> <br>
...
public interface IBotanicalLightningBlock{
	 ...
	 * @param amount
	 * Amount to add
	 * @return If the lightning was successfully added/removed
	 */
	 ...
	 *
	 * @return This blocks chunk coordinates
	 */
	...
	/**
	 * Returns maximum range to disperse lightning to. When in doubt, use 7
	 *
	 * @return Lightning Push Range
	 */
